...
<nav class="navbar bg-primary navbar-expand-lg " data-bs-theme="dark">
  <div class="container-fluid">
	...
	<h1 class="text-center">Informe de Cuentas</h1>
    ...
    <!-- Aquí se mostrará el informe procesado -->
    <c:if test="${not empty saldoTotal}">
        <div class="report-container">
            <h2>Saldo Total de Cuentas</h2>
            <p>El saldo total de las cuentas entre las fechas seleccionadas es: $${saldoTotal}</p>
        </div>
    </c:if>
</body>
</html>